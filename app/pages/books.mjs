...
<div class="mb0">
  ...
  <p class="pb-2"><strong class="capitalize">publication_date: </strong>${item?.publication_date || ''}</p>
...
<details class="mb0" ${Object.keys(problems).length ? 'open' : ''}>
  ...
  <enhance-text-input label="Publication_date" type="number" id="publication_date" name="publication_date" value="${book?.publication_date}" errors="${problems?.publication_date?.errors}"></enhance-text-input>
